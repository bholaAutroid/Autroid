...
public class LeadsRealm extends RealmObject {

    private String createdAt="", updatedAt ="",id="",primaryStatus="",status="",source="",assignee_remark="",name="",contactNo="",userId="",email="",follow_up_date="";
