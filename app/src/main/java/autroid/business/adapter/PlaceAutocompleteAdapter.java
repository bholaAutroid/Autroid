...
public class PlaceAutocompleteAdapter extends RecyclerView.Adapter<PlaceAutocompleteAdapter.PlaceViewHolder> implements Filterable {
    ...
    public PlaceAutocompleteAdapter(Context context, int resource, GoogleApiClient googleApiClient,
                                    LatLngBounds bounds, AutocompleteFilter filter, PlaceAutoCompleteInterface mListener){
...
//                        Toast.LENGTH_SHORT).show();
    ...
    public void onBindViewHolder(PlaceViewHolder mPredictionHolder, final int i) {
        if(i==0){
            mPredictionHolder.mAddress.setText("Your Current Location");
            mPredictionHolder.mSecondaryAddress.setVisibility(View.GONE);
        }
        else {
            mPredictionHolder.mSecondaryAddress.setVisibility(View.VISIBLE);
            mPredictionHolder.mAddress.setText(mResultList.get(i-1).primaryText);
            mPredictionHolder.mSecondaryAddress.setText(mResultList.get(i-1).secondaryText);
        }
    ...
    public class PlaceViewHolder extends RecyclerView.ViewHolder {
        ...
        public TextView mAddress,mSecondaryAddress;

        public PlaceViewHolder(View itemView) {
            super(itemView);
            mParentLayout = (LinearLayout) itemView.findViewById(R.id.predictedRow);
            mAddress = (TextView)itemView.findViewById(R.id.address);
            mSecondaryAddress= (TextView)itemView.findViewById(R.id.address_secondary);
        }
