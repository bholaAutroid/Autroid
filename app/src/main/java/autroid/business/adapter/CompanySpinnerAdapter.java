...
public class CompanySpinnerAdapter extends ArrayAdapter<CarItemsBE> {
    ...
    public CompanySpinnerAdapter(Context context, int resource, ArrayList<CarItemsBE> base, String defaulText) {
